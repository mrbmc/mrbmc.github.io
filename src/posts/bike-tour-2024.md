---
title: Riding The Trails From Pittsburgh to DC
date: 2024-12-01
thumbnail: /images/blog/gapco-continental-divide.JPG
description: A four-day ride from Pittsburgh to DC on the GAP and B&O trails.
...
<video controls poster="/images/optimized/gapco-potomac-preview-1920.webp" autoplay autoplay="autoplay" loop mute muted class="full-width" playsinline>
...
| :-------- | :-------- | :-------- | :-------- |
| 555 km | 930 m    | 24h 05m   | 13,828 kjul |
| 345 mi    | 3,051 ft |           |           |
...
The [Grand Allegheney Passage](https://gaptrail.org/) is an updated rail trail running from from Pittsburgh, PA to Cumberland, MD. It's a well-maintained and smooth gravel surface. As a former railroad, there is an easy grade (less than 1%) all the way from Pittsburgh to the Continental Divide in western Maryland.

The [Chesapeake & Ohio Tow Path](https://www.canaltrust.org/plan/co-canal-towpath/) from Cumberland, MD to Washington, DC has a more interesting past and condition. The Chesapeake Canal was built from Washington to Cumberland as an alternative to the Erie Canal in New York. The towpath runs alongside to allow draft animals to pull barges along the canal. The surface is less well kept than the GAP trail with more two-track, cobbles and detours.

<iframe src="https://www.komoot.com/collection/3143829/embed" width="100%" height="400" frameborder="0" scrolling="no" id="komoot"></iframe>
<style type="text/css"> 
#komoot {
height: 90vh;
}
...
- ![Penn Station](/images/blog/gapco-penn-station.JPG) {.col-3}
- ![Penn Station](/images/blog/gapco-big-bend.JPG) {.col-3}
- ![autumn](/images/blog/gapco-autumn.JPG) {.col-6 .row-2}
- ![Steel City](/images/blog/gapco-steel-city.JPG) {.col-3}
- ![Steel City](/images/blog/gapco-industrial-zone.JPG) {.col-3}
- ![rig](/images/blog/gapco-rig.JPG) {.col-6}
- ![rig](/images/blog/gapco-single-track.JPG) {.col-6}
- ![morning-whiteout](/images/blog/gapco-morning-whiteout.JPG) {.col-5}
...
- ![great-falls](/images/blog/gapco-great-falls.JPG) {.col-6}
- ![japanese-garden](/images/blog/gapco-japanese-garden.JPG) {.col-6}
