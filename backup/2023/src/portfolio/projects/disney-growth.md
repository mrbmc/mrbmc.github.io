...
masthead-image: /images/portfolio/disney-growth/everest.jpg
date: 2019-11-04
thumbnail: /images/portfolio/disney-growth.png
eleventyExcludeFromCollections: true
category:
  - work
---
Disney+ was the first time Disney would make its un-paralleled library of stories & characters available to guests. My team's mission was to design a "turnstile" for welcoming guests to a new streaming service, while providing a Disney level of care to anyone, anywhere in the world, on any device.{.large}

Adventures into the unknown are defined by overcoming unforeseen obstacles: going off the beaten path, traversing ice falls, and sometimes climbing down to go up. I'll share a selection of interesting UX challenges we faced in the multi-year saga of launching Disney+.

1. [Basecamp](#basecamp)
	1. [Growth Origin Story](#origin-story)
	2. [The Mountain of Scope](#full-scope)
	3. [Assembling the team](#project-team)
	3. [Experience Tenets](#ux-tenets)
	4. 
2. [Ascent](#ascent)
...
3. [Summit](#summit)
	...
	2. [Subscribers vs Revenue](#plan-picker)
	3. [Premier Access](#premier-access)
4. [Descent](#descent)  
	1. [Workshop for what's next](#workshop)
	2. [Outcomes](#outcomes)
...
| User Journey & Features | Devices | Payments |
| -- | -- | -- |
| Shopping<br>Turnstiles<br>Customization<br>Expansion | Mobile<br>Web<br>TV | Direct billing<br>In-App-Purchase<br>Resellers<br>Redemptions<br>Annual Plans  |
...
![Growth Team in 2018](/images/portfolio/disney-growth/growth-team-start.svg){.center}
...
![Pods](/images/portfolio/disney-growth/pod-cadence.svg)  
...
Growth Team in January 2021 {.caption}
...
We targeted several business metrics with the design: CVR, LTV, and ARPU. The commitment we made to shareholders for the first two years of operation was a singular KPI: 
...
No story about growth would be complete without a review of the landing page because it's widely considered the highest leverage point in the purchase funnel. That's a bit over-simplified since it works in harmony with other touchpoints, but it's still an easy place to do harm.

You can see the evolution of the homepage from early 2018 until mid-2021. It went from an FPO stimulus for research teams (marketing and UXR), to an optimized proven product with shared ownership between Marketing and Product.  Some changes to call out:
...
+ ![Optimized for the Bundle](/images/portfolio/disney-growth/olp-v3.jpg)
+ ![Optimized the value prop](/images/portfolio/disney-growth/olp-v4.jpg)
{.gallery}
...
+ ![Signup PS4](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.282.jpeg)
+ ![Signup PS4](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.284.jpeg)
+ ![Signup PS4](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.289.jpeg)
+ ![Signup PS4](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.294.jpeg)
+ ![Signup PS4](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.300.jpeg)
{.gallery}
...
+ ![TVOS Welcome](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.211.jpeg)
+ ![Create Account](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.212.jpeg)
+ ![TVOS Email Helper](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.213.jpeg)
+ ![User Agreement](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.218.jpeg)
+ ![Require Password](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.219.jpeg)
+ ![Input Password](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.221.jpeg)
+ ![Submit Password](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.222.jpeg)
+ ![Confirm Purchase](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.223.jpeg)
+ ![Subscriber Agreement](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.224.jpeg)
+ ![iTunes Authentication](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.227.jpeg)
+ ![TV OS Success](/images/portfolio/disney-growth/Disney_SVOD_Product_Overview_Onboarding.228.jpeg)
{.gallery}
...
In-market we saw a **33% decrease**{.negative} in conversion rate, which was alarming. Fortunately that was offset by a **200% increase**{.positive} in our Bundle take-rate. The increase in bundle sales boosted LTV & ARPU making this new design a solid win for users and the business.
...
How might we offer guests early access to theatrical releases when theaters are closed? It's a special purchase analogous to a pay-per-view.
...
I wish I could say this was a success in delighting users and driving revenue for the company.

## Subscribers vs Revenue {#plan-picker}

### Situation

In 2021 as Disney+ subscriber numbers climbed and cable carriage fees dropped, we faced some new questions about our goals. Our Finance teams confirmed that our biggest lever for increasing ARPU (or LTV) would be increasing sales of the Disney Bundle with Hulu and ESPN+. The Disney Bundle provided significantly higher user satisfaction and LTV:
...
| Standalone CVR | Standalone Take % | Bundle CVR | Bundle Take % | Overall CVR |
|-|-|-|-|-|
| +X.X%{.positive} | +XX.0%{.positive} | +X.X%{.positive} | -X.X%{.negative} | +0.X%{.positive} | 
...
This test result forced a reckoning within Disney+ Growth teams to decide if we were ready to fully commit to focusing on Revenue Growth over Subscriber Growth. Disney made new commitments to investors for the profitability of Disney+. Our focus formally moved from net subscribers to ARPU. 

# Chapter 4: Descent {#descent}


## What's Next Workshop {#workshop}
...
![](/images/portfolio/disney-growth/bundle-workshop-wireframes.jpg){.canzoom}
...
<dd>+103.6 million</dd>
<dt>Aug 2019 - Dec 2020</dt></dl><dl class="kpi"><dt>ARPU</dt>
<dd>+$48.36</dd>
