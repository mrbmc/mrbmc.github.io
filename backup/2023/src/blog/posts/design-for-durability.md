...
+ The design leverages natural laws (Physics, chemistry, psychology)
+ The design is modular and can be easy to maintain, upgrade, and repair.
...
1. Modular designs that can be **repaired** extend their lifespan
1. Higher quality materials can be **recycled** more efficiently
1. Higher quality materials often include steel, aluminum or glass. Reducing our use of synthetics has a compounding benefit on the supply chain in terms of material production, waste cycles and emissions.


![Reduce, Reuse, Recycle](/images/blog/reduce-reuse-recycle.png)
...
- Design that doesn't chase fads or look like the time period it was designed in.
- Versatile designs can adapt to multiple use cases easily
- Classic or timeless aesthetic choices that are authentic to the brand

1. Quality of manufacturing  
definition here
1. Quality of materials  
fonts colors
1. Modular construction that can be repaired  
Design systems
